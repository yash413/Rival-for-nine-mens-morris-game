...
# if it is equal to 3 hopping is executeed or else GenerateMoves is executed in the MaxMin-alb or MinMax_alb function
...
#         else  Generates the min node moves for the current board position and compares the current minimum value with MaxMin_alb value of all 
